...
public class Discussion extends Privateer {
    ...
    protected Future<Void> launchAsPrivateer() {
        ...
        return engine.startup(ctx -> {
            ctx.writeString(DiscussionContextMixin.FIELD_TOPIC, "在常规体量的Java Web项目开发中，Quarkus、Javalin、Vert.x、Spring 应如何选型？");
            ctx.writeJsonArray(DiscussionContextMixin.FIELD_MEMBERS, new JsonArray()
